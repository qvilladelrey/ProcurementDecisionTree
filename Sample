...
<head>
    ...
    <style>
        body {
            ...
            background-image: ![Example Image](https://gppbgov-my.sharepoint.com/:i:/g/personal/alvilladelrey_gppb_gov_ph/Ef5pi17YGUtCllB6QPCX3CYB3OCdtXJ9ms0ZvRFxe1JqjQ?e=RUA223);
            background-size: cover;
            background-position: center;
            background-repeat: no-repeat;
            background-attachment: fixed;
            
            /* Option 2: Keep gradient as fallback - uncomment line below if image fails to load */
...
<body>
    <div class="decision-container">
        ...
        <div id="homeContainer">
            <div class="question" style="font-size: 1.1em; text-align: left; margin-bottom: 30px;">
            ...
            <div class="options">
                <button class="option-btn" onclick="startDecisionTree()">
                    START
                </button>
            </div>
        </div>
        ...
        <div id="questionContainer" style="display: none;">
            ...
            <div class="options" id="optionsContainer">
                <button class="option-btn" onclick="makeChoice('goods')">
                    📦 Goods
                </button>
                <button class="option-btn" onclick="makeChoice('infrastructure')">
                    🏗️ Infrastructure Projects
                </button>
                <button class="option-btn" onclick="makeChoice('consulting')">
                    🤝 Consulting Services
                </button>
            </div>
        </div>
        ...
        const decisionTree = {
            ...
            need_to_action: {
                ...
                options: {
                    ...
                    replenish: {
                        text: "📋 Replenish Goods procured under zzz",
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'98fd9b5011ee6bd5',t:'MTc2MDY4MTE1Mi4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>
